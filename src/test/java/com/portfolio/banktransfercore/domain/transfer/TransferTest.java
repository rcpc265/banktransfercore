...
class TransferTest {
    ...
    void givenZeroAmount_whenCreatingTransfer_thenThrowsException() {
        ...
        // When & Then
        assertThatThrownBy(() -> new Transfer(anyId, anySourceAccount, anyDestinationAccount, zeroAmount, anyDate))
    ...
    void givenNegativeAmount_whenCreatingTransfer_thenThrowsException() {
        ...
        // When & Then
        assertThatThrownBy(() -> new Transfer(anyId, anySourceAccount, anyDestinationAccount, negativeAmount, anyDate))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Transfer amount must be greater than zero");
    }
    ...
    void givenValidArguments_whenCreatingTransfer_thenSuccessful() {
        ...
        // When
        Transfer transfer = new Transfer(expectedId, expectedSourceAccount, expectedDestinationAccount, expectedAmount, expectedDate);
