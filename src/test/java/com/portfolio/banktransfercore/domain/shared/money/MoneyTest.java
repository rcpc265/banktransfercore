...
class MoneyTest {
  ...
  class CreationAndValidationRules {
    ...
    void givenZeroAmount_whenCreatingMoney_thenSucceeds() {
      assertThatCode(() -> Money.of("0.00", SupportedCurrency.PEN)).doesNotThrowAnyException();
    }
  ...
  class ImmutabilityAndMath {
    ...
    @Test
    @DisplayName(
        "Subtraction returns a new Money object with the difference without mutating original")
